...
<script type="text/javascript" src="js/demoschedule.js"></script>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Enter Search Dates</h4>
      </div>
      <div class="modal-body">
<!--         <p>Search Dates</p> -->
        <!-- new form -->
		<form class="form-inline" role="form" method="get" action="demoschedule.php">
